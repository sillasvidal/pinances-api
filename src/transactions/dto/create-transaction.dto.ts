...
export class CreateTransactionDto {
  ...
  @ApiProperty({ enum: ['expense', 'income', 'transfer'], example: 'expense', description: 'Transaction type' })
  ...
  @ApiPropertyOptional({ example: 'uuid-account', description: 'Account UUID' })
  @IsUUID()
  @IsOptional()
  account_id?: string;

  @ApiPropertyOptional({ example: 'uuid-invoice', description: 'Invoice UUID' })
  @IsUUID()
  @IsOptional()
  invoice_id?: string;
